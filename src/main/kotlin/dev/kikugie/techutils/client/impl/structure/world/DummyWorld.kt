...
abstract class DummyWorld(protected val client: MinecraftClient) : World(
    ...
    private val biome = client.world!!.registryManager.get(RegistryKeys.BIOME).entryOf(BiomeKeys.PLAINS)
    ...
    override fun getEnabledFeatures() = client.world?.enabledFeatures ?: FeatureFlags.DEFAULT_ENABLED_FEATURES
